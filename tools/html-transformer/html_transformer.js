/**
 * @fileoverview A collection of utilities for performing static analysis on
 *     and transforming apps' html files.
 */
...
HTMLTransformer.prototype = {
  getSharedDependencies: function() {
    ...
    return links.concat(scripts).concat(commented).map(function(dependency) {
      // TODO(gaye): Choose the right locale...
      return dependency.replace('{locale}', 'en-US');
    });
  }
};
...
module.exports = { HTMLTransformer: HTMLTransformer, load: load };
